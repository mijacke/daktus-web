...
/** Sem-tam sa krátko rozhojdá doprava-doľava a z náklonu potom skáče. */
const sway = css({
  transformOrigin: '50% 88%',
  animation: 'claySway 7.4s ease-in-out infinite',
  _motionReduce: { animation: 'none' },
})

/** Raz za deväť sekúnd si poskočí — pružne, z aktuálneho náklonu hojdania. */
const jump = css({
